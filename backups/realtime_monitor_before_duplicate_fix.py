...
class RDRSEventHandler(FileSystemEventHandler):
    ...
    def process_event(self, event_type, file_path):
        ...
        # ==========================================
        # FINAL STATUS SAFETY FIX
        # ==========================================
        #
        # If the response engine successfully quarantined
        # the file, make sure the incident is also marked
        # CONTAINED.
        #
