...
async def upload_file(file: UploadFile = File(...)):
    ...
    try:
        ...
        scanned_file = analysis["file"]

        # Create risk object compatible with IncidentManager
        risk = {
        ...
        # Save incident only when suspicious
        incident = None
        ...
        if scan_result["suspicious"]:
            ...
            print(
                f"[RDRS] Upload Response : {response_status}"
            )

            if response_status == "quarantined":
                print(
                    f"[RDRS] Quarantine Path : "
        ...
        return {
            ...
            "scan_result": {
                ...
                "risk_level": scan_result["risk_level"],
                "suspicious": scan_result["suspicious"],
                "risk_reasons": scan_result["reasons"]
            },
